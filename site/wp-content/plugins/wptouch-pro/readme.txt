...
= Version 3.9 (Oct 29, 2015) =

* Updated: Allows upgrade to WPtouch 4.x

= Version 3.8.8 (Oct 2, 2015) =

* Fixed: Issue with listing of draft posts in some WordPress configurations.
* Fixed: For customers using Divi theme, trigger earlier builder component load for better shortcode compatibility
* Fixed: CMS - compatibility with 'EU Cookie' plugin
