	...
	class All_in_One_SEO_Pack_Performance extends All_in_One_SEO_Pack_Module {
		...
		function get_serverinfo() {
			...
			$buf =	"<ul class='sfwd_debug_settings'>\n{$page_text}\n</ul>\n<p>\n" .
					...
					$nonce . '"><input name="sfwd_debug_submit" type="submit" value="' . __( 'Submit', 'all-in-one-seo-pack' ) . '" class="button-primary"><p><input name="sfwd_update_check" type="submit" value="' . __( 'Check For Updates', 'all-in-one-seo-pack' ) . '" class="button-primary">';
			return $buf;
		}
	}
}