...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
	...
	function All_in_One_SEO_Pack() {
		...
		$help_text = Array(
			...
			"taxactive" 			=> __( "Use these checkboxes to select which Taxonomies you want to use All in One SEO Pack with.<br /><a href='http://semperplugins.com/documentation/custom-post-type-settings/' target='_blank'>Click here for documentation on this setting</a>", 'all_in_one_seo_pack' ),
			...
			"tax_noindex"			=> __( "Check this to ask search engines not to index custom Taxonomy archive pages. Useful for avoiding duplicate content.<br /><a href='http://semperplugins.com/documentation/noindex-settings/' target='_blank'>Click here for documentation on this setting</a>", 'all_in_one_seo_pack' ),
		   ...
		   "404_title_format"=> Array( 
			...
			$this->layout = Array(
				...
				'noindex' => Array(
						...
						'options' => Array( 'cpostnoindex', 'cpostnofollow', 'category_noindex', 'archive_date_noindex', 'archive_author_noindex', 'tags_noindex', 'search_noindex', 'tax_noindex', 'paginated_noindex', 'paginated_nofollow', 'noodp', 'noydir' )
					),
				'advanced' => Array(
