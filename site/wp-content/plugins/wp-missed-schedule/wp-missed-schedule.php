					...
					if ( $file == plugin_basename( __FILE__ ) )
						{
							...
							$links[] = '<a title="'. __( 'Premium Support' ) .'" href="https://slangji.wordpress.com/support/">'. __( 'Contact' ) .'</a>';
						}
					return $links;
				}
